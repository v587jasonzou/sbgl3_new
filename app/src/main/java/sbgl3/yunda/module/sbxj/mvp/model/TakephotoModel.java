...
public class TakephotoModel extends BaseModel implements TakephotoContract.Model {
    ...
    @Inject
    public TakephotoModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponsBean> ConfirmRecord(String ids, String checkResult, String filePathArray) {
        return mRepositoryManager.obtainRetrofitService(SbxjApi.class).ConfirmRecord(ids,checkResult,filePathArray)
                .subscribeOn(Schedulers.io());
    }
}