...
@ActivityScope
public class TakephotoPresenter extends BasePresenter<TakephotoContract.Model, TakephotoContract.View> {
    @Inject
    ...
    @Inject
    public TakephotoPresenter(TakephotoContract.Model model, TakephotoContract.View rootView) {
...
//                                mRootView.UpLoadImagesSuccess();
    ...
    public void ConfirmRecord(String ids,String checkResult,String filePathArray){
        mModel.ConfirmRecord(ids,checkResult,filePathArray).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<BaseResponsBean>() {
                    @Override
                    public void onSubscribe(Disposable d) {
