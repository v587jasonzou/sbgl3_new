...
@ActivityScope
public class NewBuildTicketPresenter extends BasePresenter<NewBuildTicketContract.Model, NewBuildTicketContract.View> {
    @Inject
    ...
    @Inject
    public NewBuildTicketPresenter(NewBuildTicketContract.Model model, NewBuildTicketContract.View rootView) {
...
//                        mRootView.hideLoadingFaild("未获取到相关照片信息",3000);
                    ...
                    public void onError(Throwable e) {
//                        mRootView.hideLoading();
                        ToastUtils.showShort("未获取到相关照片信息"+e.getMessage());
