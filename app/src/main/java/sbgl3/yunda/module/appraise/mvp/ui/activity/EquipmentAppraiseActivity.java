...
import sbgl3.yunda.module.appraise.di.component.DaggerEquipmentAppraiseComponent;
...
import sbgl3.yunda.module.appraise.mvp.presenter.EquipmentAppraisePresenter;
import sbgl3.yunda.module.appraise.mvp.ui.adapter.AppraiseEquipmentAdapter;
 ...
 * @version 3.0
 */
public class EquipmentAppraiseActivity extends BaseActivity<EquipmentAppraisePresenter> implements EquipmentAppraiseContract.View {
    ...
    List<EquipmentAppraiserBean> mList = new ArrayList<EquipmentAppraiserBean>();
    AppraiseEquipmentAdapter adapter;
    boolean isScanEquip = false;

    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerEquipmentAppraiseComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .equipmentAppraiseModule(new EquipmentAppraiseModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_equipment_appraise; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new AppraiseEquipmentAdapter(mList);
        ...
        adapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int viewType, Object data, int position) {
                Intent intent = new Intent(EquipmentAppraiseActivity.this, EquipmentAppraiseResultEditActivity.class);
    ...
    private void loadData() {
        ...
        mPresenter.getAppraiseEquipment(planStatus, start, limit, JSON.toJSONString(map), isLoadmore);
    }
        ...
        if (null == window) {
            ...
            window = CustomPopupWindow.builder().contentView(view).customListener(new CustomPopupWindow.CustomPopupWindowListener() {
                ...
                public void initPopupView(View contentView) {
                    ...
                    ArmsUtils.configRecycleView(rlPopUpMenu, new GridLayoutManager(EquipmentAppraiseActivity.this, 3, OrientationHelper.VERTICAL, false));
                    menuAdapter = new MenuAdapter(SysInfo.menus, EquipmentAppraiseActivity.this);
                    menuAdapter.setNowData("设备鉴定");
...
//                window.setAnimationStyle(R.style.popwin_anim_style);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        intentFilter.addAction("action.refreshEquiAppraiseList");
    ...
    private BroadcastReceiver mRefreshBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("action.refreshEquiAppraiseList")) {
                isLoadmore = false;
                loadData();
            }
        }
     ...
     */
    @Override
    public void LoadData(List<EquipmentAppraiserBean> list) {
     ...
     */
    @Override
    public void LoadMoreData(List<EquipmentAppraiserBean> list) {
    ...
    @OnClick(R.id.ivScan)
    void onScanStart() {
        Intent intent = new Intent(EquipmentAppraiseActivity.this, CaptureActivity.class);
