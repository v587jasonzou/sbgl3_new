 ...
 * @version 1.0
 */
public class AppraiseEquipmentHolder extends BaseHolder<EquipmentAppraiserBean> {
    ...
    public AppraiseEquipmentHolder(View itemView) {
        super(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void setData(EquipmentAppraiserBean data, int position) {
        if (null != data){
            ...
            String str = "";
            if(data.getModel()!=null&&!data.getModel().toString().equals("")){
                str = str+data.getModel();
            }
            if(data.getSpecification()!=null&&!data.getSpecification().toString().equals("")){
                if (data.getModel()!=null&&!data.getModel().toString().equals("")){
                    str = str +",";
                }
