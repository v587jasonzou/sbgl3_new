...
import sbgl3.yunda.module.ysrqr.di.component.DaggerYsrqrEquipmentListComponent;
...
import sbgl3.yunda.module.ysrqr.mvp.presenter.YsrqrEquipmentListPresenter;
import sbgl3.yunda.module.ysrqr.mvp.ui.adapter.PlanRepairAdapter;
 ...
 * @version 3.0
 */
public class YsrqrEquipmentListActivity extends BaseActivity<YsrqrEquipmentListPresenter> implements YsrqrEquipmentListContract.View {
    ...
    List<PlanRepairEquipListBean> mAllPlanRepairList = new ArrayList<>();
    PlanRepairAdapter adapter;   // 计划修列表适配器

    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerYsrqrEquipmentListComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .ysrqrEquipmentListModule(new YsrqrEquipmentListModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_ysrqr_equipment_list; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int viewType, Object data, int position) {
                Intent intent = new Intent(YsrqrEquipmentListActivity.this, YsrWorkOrderConfirmActivity.class);
                intent.putExtra("allPlanRepairList", (Serializable) mAllPlanRepairList);
        ...
        if (null == window) {
            ...
            window = CustomPopupWindow.builder().contentView(view).customListener(new CustomPopupWindow.CustomPopupWindowListener() {
                ...
                public void initPopupView(View contentView) {
                    ...
                    ArmsUtils.configRecycleView(rlPopUpMenu, new GridLayoutManager(YsrqrEquipmentListActivity.this, 3, OrientationHelper.VERTICAL, false));
                    menuAdapter = new MenuAdapter(SysInfo.menus, YsrqrEquipmentListActivity.this);
                    menuAdapter.setNowData("验收人确认");
    ...
    private void loadData(){
        ...
        if (null!=mPresenter){
            mPresenter.getEquipments(start,limit, JSON.toJSONString(map),isLoadMore);
            mPresenter.getAllEquipments(JSON.toJSONString(map));
        }
    }
    @Override
    public void showLoading() {
        ProgressDialogUtils.showProgressDialog(this,"正在加载，请稍后.....");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter.addAction("action.refreshYsrqrEuipmentList");
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("action.refreshYsrqrEuipmentList")){
                start = 0;
                isLoadMore = false;
                loadData();
            }
    ...
    @Override
    public void loadAllData(List<PlanRepairEquipListBean> list) {
        mAllPlanRepairList.clear();
        if (list.size()>0){
            mAllPlanRepairList.addAll(list);
        }
    }
    ...
    @OnClick(R.id.ivScan)
    void onScanStart() {
        Intent intent = new Intent(YsrqrEquipmentListActivity.this, CaptureActivity.class);
