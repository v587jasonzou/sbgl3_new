 ...
 * @version 1.0
 */
public class CheckItemsHolder extends BaseHolder<EquipmentEvaluatePlanBean>{
    ...
    public CheckItemsHolder (EquipmentEvaluateCheckItemActivity activity,View itemView){
        super(itemView);
    ...
    @Override
    public void setData(EquipmentEvaluatePlanBean data, int position) {
        if (null != data){
