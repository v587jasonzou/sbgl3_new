...
import sbgl3.yunda.module.tpgzpg.di.component.DaggerBackDispatcherComponent;
...
import sbgl3.yunda.module.tpgzpg.mvp.presenter.BackDispatcherPresenter;
 ...
 * @version 3.0
 */
public class BackDispatcherActivity extends BaseActivity<BackDispatcherPresenter> implements BackDispatcherContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerBackDispatcherComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .backDispatcherModule(new BackDispatcherModule(this))
                .build()
                .inject(this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.iv_right) {
            ...
            if (null != mPresenter) {
                showLoading();
                mPresenter.back(idx, etBackReason.getText().toString(),"工长");
            }
        }
